...
const (
	MAX_RESPONSE_PACKET_SIZE = 4096

	TYPE_AUTH = 3 // LOGIN, SERVERDATA_AUTH
	TYPE_AUTH_RESPONSE = 2 // SERVERDATA_AUTH_RESPONSE
	TYPE_COMMAND = 2 // COMMAND, SERVERDATA_EXECCOMMAND
	TYPE_COMMAND_RESPONSE = 0 // COMMAND RESPONSE, SERVERDATA_RESPONSE_VALUE
)
